...
export const FirstRegularTabSell = () => {
        ...
        <View style={{ flex: 1 }}>
            <ScrollView style={{ backgroundColor: 'white', }}>
                    ...
                    <View style={{ position: 'absolute', flexDirection: 'row', padding: 20, justifyContent: 'center', alignItems: 'center', columnGap: 10, height: 110, elevation: 2, bottom: 15, left: 20, right: 20, backgroundColor: 'white', borderRadius: 4 }}>
                        <View style={{ rowGap: 13, width: '50%' }}>
                            ...
                            <View style={{ height: 50, flexDirection: 'row', position: 'relative', borderWidth: 0.7, borderColor: 'lightgray', borderRadius: 4, overflow: 'hidden' }}>
                                <TextInput cursorColor={"#da494f"} keyboardType={"number-pad"} style={{ width: '80%', paddingLeft: 5, fontSize: 20 }} />
                ...
                <View style={{ paddingLeft: 20, paddingRight: 20, marginTop: 20, rowGap: 10 }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                        <View style={{ height: 40, borderColor: '#da494f', borderWidth: 1, columnGap: 5, borderRadius: 2, width: '48%', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ fontSize: 11, color: "#da494f" }}>
                                Intraday
                            </Text>
                            <Text style={{ fontSize: 11, opacity: 0.4, color: "#da494f" }}>
                                MIS
                            </Text>
                        </View>
                ...
                <View style={{ paddingLeft: 20, paddingRight: 20, marginTop: 20, rowGap: 10 }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: "space-between" }}>
                        <View style={{ height: 40, borderColor: '#da494f', borderWidth: 1, columnGap: 5, borderRadius: 2, width: 80, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ fontSize: 11, color: "#da494f" }}>
                                Market
                            </Text>
                        </View>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 20, paddingLeft: 20, paddingRight: 20 }}>
                    ...
                    <View style={{ borderRadius: 2, borderColor: "#da494f", width: 100, height: 25, borderWidth: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', columnGap: 5 }}>
                        <FeatureIcon name="plus" color="#da494f" size={16} />
                        <Text style={{ color: "#da494f", fontSize: 12 }}>Add tags</Text>
                    </View>
                </View>
                    ...
                    <>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 20, paddingLeft: 20, paddingRight: 20 }}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: "space-between", width: '60%' }}>
                                <View style={{ height: 40, borderColor: '#da494f', borderWidth: 1, columnGap: 5, borderRadius: 2, width: 50, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                                    <Text style={{ fontSize: 11, color: "#da494f" }}>
                                        DAY
                                    </Text>
                                </View>
                        ...
                        <View style={{ rowGap: 13, paddingBottom: 30, paddingLeft: 20, paddingRight: 20, marginTop: 20 }}>
                            ...
                            <View style={{ flexDirection: 'row', columnGap: 10 }}>
                                <View style={{ height: 50, width: '49%', flexDirection: 'row', position: 'relative', borderWidth: 0.7, borderColor: 'lightgray', borderRadius: 4, overflow: 'hidden' }}>
                                    <TextInput defaultValue={"0"} cursorColor={"#da494f"} keyboardType={"number-pad"} style={{ width: '80%', paddingLeft: 5, fontSize: 20 }} />
                                </View>
                                <View style={{ height: 50, width: '49%', flexDirection: 'row', position: 'relative', borderWidth: 0.7, borderColor: 'lightgray', borderRadius: 4, overflow: 'hidden' }}>
                                    <TextInput defaultValue='1 minute' cursorColor={"#da494f"} keyboardType={"number-pad"} style={{ width: '90%', paddingLeft: 10, fontSize: 14 }} />
                                </View>
                            </View>
                        </View>
                    </>
            ...
            <View style={{ height: 180, backgroundColor: 'white', elevation: 10, bottom: 0, right: 0, left: 0, position: 'absolute' }}>
                <View style={[{ height: 40, backgroundColor: '#e7e7e7', paddingLeft: 15, paddingRight: 15, justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row' }]}>
                    <View style={{ flexDirection: 'row', columnGap: 20 }}>
                        <View style={{ flexDirection: 'row', columnGap: 10 }}>
                            ...
                            <Text style={{ color: '#da494f', fontSize: 12 }}>₹2,939.90</Text>
                        </View>
                        <View style={{ flexDirection: 'row', columnGap: 10 }}>
                            <Text style={{ fontSize: 12, color: 'gray' }}>Charges</Text>
                            <Text style={{ color: '#da494f', fontSize: 12 }}>₹5.80</Text>
                        </View>
                    </View>
                ...
                <View style={{ height: 140, paddingLeft: 20, paddingTop: 15, paddingRight: 20, flexDirection: 'row', justifyContent: 'center' }}>
                    {/* <View style={{ width: 250, height: 60, borderRadius: 100, backgroundColor: '#da494f', position: 'relative' }}>
                        <GestureDetector gesture={panGesture}>
                            <Animated.View style={[eStyle, { height: 60, width: 60, justifyContent: 'center', alignItems: 'center', backgroundColor: 'white', borderRadius: 100, borderWidth: 3, borderColor: "#da494f" }]}>

                                <FeatureIcon name="chevron-right" color="#da494f" size={30} />
                    ...
                    <SwipeButtonCustom primaryColor="#da494f"/>
...
export const FirstCoverTabSell = () => {
...
export const FirstIcebergTabSell = () => {
    const [hideExtra, setHideExtra] = useState(false);
...
export const SecondRegularTabSell = () => {
...
export const SecondIcebergTabSell = () => {
    const [hideExtra, setHideExtra] = useState(false);
